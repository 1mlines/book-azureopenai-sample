        ...
        <div className={styles.oneshotContainer}>
            <div className={styles.oneshotTopSection}>
                ...
                <div className={styles.oneshotQuestionInput}>
                    <QuestionInput placeholder="질문을 작성해주세요." disabled={isLoading} onSend={question => makeApiRequest(question)} />
                </div>
            </div>
            <div className={styles.oneshotBottomSection}>
                {isLoading && <Spinner label="답변을 생성중입니다..." />}
            ...
            >
                ...
                />
                <TextField className={styles.oneshotSettingsSeparator} label="제외 항목" onChange={onExcludeCategoryChanged} />
                <Checkbox
                    className={styles.oneshotSettingsSeparator}
