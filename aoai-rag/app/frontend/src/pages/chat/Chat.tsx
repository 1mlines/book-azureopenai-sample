            ...
            <div className={styles.chatRoot}>
                <div className={styles.chatContainer}>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput clearOnSend placeholder="질문을 작성해주세요." disabled={isLoading} onSend={question => makeApiRequest(question)} />
                    </div>
                </div>
                ...
                >
                    ...
                    />
                    <TextField className={styles.chatSettingsSeparator} label="제외 항목" onChange={onExcludeCategoryChanged} />
                    <Checkbox
                        className={styles.chatSettingsSeparator}
